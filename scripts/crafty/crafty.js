        ...
        if (closest) {
            ...
            if (type === "mousedown") {
                ...
                if (this.over !== closest) { //if new mousemove, it is over
                    if (this.over) {
                        this.over.trigger("MouseOut"); //if over wasn't null, send mouseout
                        this.over = null;
                    }
                    this.over = closest;
                    closest.trigger("MouseOver");
                }
            } else closest.trigger(type); //trigger whatever it is
        } else {
    ...
    timer: (function () {
        ...
        return {
            ...
            step: function () {
                ...
                if (endTime > 0)
                    Crafty.trigger("MeasureWaitTime");
                ...
                for (var i = 0; i < loops; i++) {
                    ...
                    gameTime += dt;
                    currentTime = new Date().getTime();
                    Crafty.trigger("MeasureFrameTime");
                }
                ...
                if (loops > 0) {
                    ...
                    currentTime = new Date().getTime();
                    Crafty.trigger("MeasureRenderTime");
                }
